...
@mcp.tool()
def get_spatial_addresses(
    client,
    json_data: Dict[str, Any],
    x_request_id: Optional[str] = None
) -> Dict[str, Any]:
    """
    Get Addresses using Spatial Query (WKT or GeoJSON geometry).

    --------
    Required Payload Structure:
    {
        "query": '''
            query GetSpatialAddresses(
                $wkt: String,
                $geoJson: String,
                $address: String,
                ...
                getBySpatial(
                    ...
                    inputID
                    addresses(pageNumber: 1, pageSize: 100) {
                        metadata {
                            pageNumber
                            pageCount
                            totalPages
        ...
        "variables": {
            ...
            "inputID": "address-search-123"            # OPTIONAL - Custom input ID
        }
    }
    ...
    Returns:
        dict: Addresses within the specified geometry
...
@mcp.tool()
def get_spatial_buildings(
    client,
    json_data: Dict[str, Any],
    x_request_id: Optional[str] = None
) -> Dict[str, Any]:
    """
    Get Buildings using Spatial Query (WKT or GeoJSON geometry).

    --------
    Required Payload Structure:
    {
        "query": '''
            query GetSpatialBuildings(
                $wkt: String,
                $geoJson: String,
                $address: String,
                $spatialFunction: SpatialFunction!,
        ...
        "variables": {
            ...
            "address": "Boston, MA",                   # OPTIONAL - Address context
            "spatialFunction": "INTERSECTS",           # REQUIRED - One of: INTERSECTS, WITHIN, CONTAINS, TOUCHES, OVERLAPS
            "inputID": "buildings-search-123"          # OPTIONAL - Custom input ID
        }
    }
    ...
    Returns:
        dict: Buildings within the specified geometry
...
def get_spatial_parcels(
    ...
    """
    Get Parcels using Spatial Query (WKT or GeoJSON geometry).

    --------
    Required Payload Structure:
    {
        "query": '''
            query GetSpatialParcels(
                $wkt: String,
                $geoJson: String,
                $address: String,
                $spatialFunction: SpatialFunction!,
                ...
                getBySpatial(
                    ...
                    inputID
                    parcels(pageNumber: 1, pageSize: 100) {
                        metadata {
                            pageNumber
                            pageCount
                            totalPages
        ...
        "variables": {
            ...
            "address": "Boston, MA",                   # OPTIONAL - Address context
            "spatialFunction": "INTERSECTS",           # REQUIRED - One of: INTERSECTS, WITHIN, CONTAINS, TOUCHES, OVERLAPS
            "inputID": "parcels-search-123"            # OPTIONAL - Custom input ID
        }
    }
    ...
    Returns:
        dict: Parcels within the specified geometry
...
@mcp.tool()
def get_spatial_places(
    client,
    json_data: Dict[str, Any],
    x_request_id: Optional[str] = None
) -> Dict[str, Any]:
    """
    Get Places using Spatial Query (WKT or GeoJSON geometry).

    --------
    Required Payload Structure:
    {
        "query": '''
            query GetSpatialPlaces(
                $wkt: String,
                $geoJson: String,
                $address: String,
                $spatialFunction: SpatialFunction!,
                ...
                getBySpatial(
                    ...
                    inputID
                    places(pageNumber: 1, pageSize: 100) {
                        metadata {
                            pageNumber
                            pageCount
                            totalPages
        ...
        "variables": {
            ...
            "address": "Boston, MA",                   # OPTIONAL - Address context
            "spatialFunction": "INTERSECTS",           # REQUIRED - One of: INTERSECTS, WITHIN, CONTAINS, TOUCHES, OVERLAPS
            "inputID": "places-search-123"             # OPTIONAL - Custom input ID
        }
    }
    ...
    Returns:
        dict: Places within the specified geometry
